...
import {Image, Progress, Table, Tooltip} from "antd";
...
export const HomeScreen = () => {
    ...
    const columns = [
            ...
            },
            {
                ...
                render: (rating: number) => {
                    if (rating) {
                        return (
                            <Tooltip title={`${rating} of 5`}>
                                <Progress percent={rating * 20} showInfo={false} format={() => {
                                    return `${rating} of 5`
                                }}/>
                            </Tooltip>)
                    } else {
    ...
    return (
        <HomeComponent columns={columns} products={products} error={error} loading={loading}/>
    );
}
